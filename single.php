			...
			<?php if ( function_exists( "the_field" ) ) : ?>
                    ...
                    <div class="container">
                        ...
                        <div class="row justify-content-center mb-3">
                            <div class="col-md-7 text-center">
                                <h2 class="font-weight-light text-black"><?php echo $author;
				...
				<?php if ( ! empty( $tour_guide ) ): ?>
                    <div class="container">
                        ...
                        <div class="row justify-content-center mb-3">
                            <div class="col-md-7 text-center">
                                <h2 class="font-weight-light text-black"><?php esc_html_e($more_name, "greenbelt" ); ?></h2>
                            </div>
                        </div>
