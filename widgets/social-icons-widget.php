...
class GreenbeltSocialIcons_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __( 'Green Belt: Social Icons', 'greenbelt' ), // Name
            array( 'description' => __( 'Social Icons', 'greenbelt' ), ) // Args
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        ?>
        <ul class="list-unstyled d-flex offset-lg-0 offset-md-0 offset-5">
            <?php
            if ( $title ) {
...
function greenbelt_social_icons_widget() {
    register_widget( 'GreenbeltSocialIcons_Widget' );
}

add_action( 'widgets_init', 'greenbelt_social_icons_widget' );
